...
def get_parser():
    ...
    parser.add_argument('-s', '--source-lang', default="ch", metavar='SRC', help='source language')
    parser.add_argument('-t', '--target-lang', default="en", metavar='TARGET', help='target language')
    parser.add_argument('--trainpref', metavar='FP', default="../test_data/train", help='target language')
    parser.add_argument('--validpref', metavar='FP', default='../test_data/valid', help='comma separated, valid language prefixes')
